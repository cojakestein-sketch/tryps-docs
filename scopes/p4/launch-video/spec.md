...
A social launch announcement video for Tryps — a ~2-minute hero cut plus shorter social edits — showing real friends on a real trip with the app appearing naturally in the story. Backed by a production-ready treatment document and game plan that Jake can hand to creative collaborators.

## Why

Tryps needs a "we exist" moment. The launch video is the first impression for everyone who discovers Tryps on social media. A great video drives downloads, builds brand recognition, and sets the visual tone for the brand.

## Intent

> "Like Poke's energy exactly." A cinematic, story-driven launch film — not a feature demo, not a typical startup video. Real friends, real trip, app woven in. Poke told a love story in Paris and let the product show up naturally. Tryps does the same but with a friend group on an adventure. The vibe is "let's go explore" — casual, authentic, elevated. NOT stock footage, NOT luxury influencer, NOT overproduced.
...
- Full social media content calendar or ongoing posting strategy — separate scope
- App Store preview video — different format, different requirements
- Influencer partnership contracts or paid distribution plan — separate scope
- Original music composition — use licensed or royalty-free tracks within budget
- Website landing page video embed — can reuse the hero cut later

### Regression Risk

| Area | Why | Risk |
|------|-----|------|
| Brand alignment | Video sets the visual tone for all future Tryps marketing | High |
| Launch timeline | Video must ship before April 2026 — delays cascade to launch | High |
| Budget | $5-7K is tight for cinematic quality — scope creep kills it | Med |
